...
namespace OchestratorF5
{
    class F5Interface
    {
        ...
        public List<F5LBVirtualServerMember> GetLBVirtualServerMembers(string virtualServerName)
        {
            // Create a list of F5 Pools Member Objects
            List<F5LBVirtualServerMember> F5VirtualServerMembers = new List<F5LBVirtualServerMember>();
            ...
            if (isF5Connected)
            {
                ...
                {
                    F5LBVirtualServerMember virtualServer = new F5LBVirtualServerMember(virtualServerName, bigIPVirtualMemberDefaultPool[i], bigIPVirtualMember[i], bigIPVirtualMemberStatus[i]);
        ...
        public List<F5LBPoolMember> GetLBPoolMember(string poolName, string poolMember)
        {
