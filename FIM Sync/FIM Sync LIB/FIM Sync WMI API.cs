            ...
            using (ManagementObjectCollection services = managementClass.GetInstances())
            {
                foreach (ManagementObject service in services)
                {
                    if (service["Name"].ToString().ToLower().CompareTo(fimMAName.ToLower()) == 0)
                    {
                        ...
                        newAgent.Name = fimMAName;
                        newAgent.Profile = fimProfileName;
                        ...
                        try
                        {
                            ...
                            if (newAgent.Status.Contains("success") || newAgent.Status.Contains("complet"))
                            {
                                ...
                                {
                                    newAgent.NumImportNoChange = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumImportAdd = ex.ToString();
                                }

                                // Import Updates
                                try
                                {
                                    outParams = service.InvokeMethod("NumImportUpdate", null, null);
                                    newAgent.NumImportUpdate = outParams["ReturnValue"].ToString();
                                }
                                catch (Exception ex)
                                {
                                    newAgent.NumImportUpdate = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumImportDelete = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumExportAdd = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumExportUpdate = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumExportDelete = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumCSObjects = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumTotalConnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumConnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumExplicitConnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumTotalDisconnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumDisconnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumExplicitDisconnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumFilteredDisconnectors = ex.ToString();
                                }
                                ...
                                {
                                    newAgent.NumPlaceholders = ex.ToString();
                                }
                            }
